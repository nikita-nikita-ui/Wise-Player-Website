...
const PlaylistManager = () => {
  const [macAddress] = useState("SH:19:BD:FO:AO:AO");
  const [deleteMac, setDeleteMac] = useState("SH:19:BD:FO:AO:AO");
  ...
  return (
    <div style={{ backgroundColor: '#212529', minHeight: '100vh', padding: '40px 20px', color: 'white', fontFamily: "'Segoe UI', Roboto, sans-serif" }}>
      <motion.div 
        className="container" 
      ...
      >
        ...
        >
          <div className="mb-4">
            ...
            <div>
              <motion.div 
                ...
                style={{ backgroundColor: '#FFD54F', display: 'inline-block', padding: '10px 25px', borderRadius: '10px', fontWeight: '800', fontSize: '1.1rem', boxShadow: '0 4px 15px rgba(255, 213, 79, 0.3)' }}
          ...
          <motion.button 
            ...
            style={{ top: '25px', right: '25px', backgroundColor: '#FFD54F', border: 'none', width: '45px', height: '45px', borderRadius: '12px', boxShadow: '0 4px 10px rgba(0,0,0,0.1)' }}
          >
              ...
              {links.map((link, index) => (
                ...
                >
                  ...
                  <div className="col-md-6">
                    ...
                    <input type="text" className="form-control border-0 bg-light shadow-sm" placeholder="Put your link" style={{ height: '45px' }} />
                  </div>
                  <div className="col-md-3">
                    <label className="small fw-bold text-muted d-block mb-1">Name</label>
                    <input type="text" className="form-control border-0 bg-light shadow-sm" placeholder="Name" style={{ height: '45px' }} />
                  </div>
          ...
          <div className="d-flex justify-content-end mt-5 gap-3">
            ...
            >
              <FaChevronLeft className="me-2" size={12} /> Back
            </motion.button>
            <motion.button 
              variants={buttonHover} whileHover="hover" whileTap="tap"
              className="btn px-5 py-2 fw-bold d-flex align-items-center border-0" 
              style={{ backgroundColor: '#FFD54F', borderRadius: '10px', boxShadow: '0 4px 15px rgba(255, 213, 79, 0.2)' }}
            >
              Save <FaChevronRight className="ms-2" size={12} />
            </motion.button>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="d-flex justify-content-end">
            <motion.button 
              ...
              style={{ backgroundColor: '#FFD54F', borderRadius: '10px' }}
            >
